...
{
public:
	SpecUnionCls(std::string& sEngineFilePath);
	...
	//std::vector<std::string> m_viewNameMap = { "MV", "TR", "PA", "Ao", "TR", "TDIMVIVS", "TDIMVLW", "OTHER_VIEW" };
	// 20250326更新：20240718版本的PA和Ao应该是对调的
	std::vector<std::string> m_viewNameMap = { "MV", "TR", "Ao", "PA", "TR", "TDIMVIVS", "TDIMVLW", "OTHER_VIEW" };
