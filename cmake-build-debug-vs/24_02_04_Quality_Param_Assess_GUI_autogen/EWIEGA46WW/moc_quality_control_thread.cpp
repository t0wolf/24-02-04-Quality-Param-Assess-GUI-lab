...
QT_MOC_LITERAL(1, 21, 25), // "sigQualityScoresAvailable"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 8) // "qVResult"

    },
    "QualityControlThread\0sigQualityScoresAvailable\0"
    "\0qVResult"
};
...
void QualityControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigQualityScoresAvailable((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QualityControlThread::sigQualityScoresAvailable)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QualityControlThread::sigQualityScoresAvailable(QVariant _t1)
{
