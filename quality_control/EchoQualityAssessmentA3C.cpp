...
EchoQualityAssessmentA3C::EchoQualityAssessmentA3C(EchoQualityAssessmentParams params)
{
    // -------------------------------- 先验知识参数初始化 -------------------------------- //
    this->mParams = &params;
    // 切面类型名称
    ...
    this->structure_score_structures.routine_must = { "AO","LA","LV","LVOT","IVS","LVPW"};  // 常规必须项结构
    this->structure_score_structures.routine_optional = { "MV" };// 常规可选项结构
    ...
    this->structure_score_weight.routine_optional = { 1.0f };        // 常规可选项结构分数权重
 ...
 //   this->mParams->sdetection_params.model_dir = "../../extern/structure_detection/";
    ...
    this->mParams->ac_params.viewname = "a3c";
    ...
    this->mParams->ac_params.model_name = "a3c_lv_segmentation";
    ////// update 2023.12.28
    ...
    this->mParams->gain_params.viewname = "a3c";
    ...
    this->load_structure_model();                                // 解剖结构检测模型载入
    this->load_gain_model();                                     // 图像增益模型载入
    //this->load_keyframe_model();                                 // 关键帧检测模型载入
    //this->load_angle_model();                                    // 心轴角度模型载入

}

EchoQualityAssessmentA3C::~EchoQualityAssessmentA3C()
{
...
void
EchoQualityAssessmentA3C::load_structure_model()
{
...
//void
//EchoQualityAssessmentA3C::load_keyframe_model()
//{
...
void
EchoQualityAssessmentA3C::load_gain_model()
{
...
//void
//EchoQualityAssessmentA3C::load_angle_model()
//{
...
float EchoQualityAssessmentA3C::structure_judgment(s_frames structure_frames,
...
float
EchoQualityAssessmentA3C::scaling_judgment(s_frames structure_frames,
...
float
EchoQualityAssessmentA3C::gain_judgment(
...
//float
//EchoQualityAssessmentA3C::mandrel_judgment(
//    f_structures frame_structures,
//    std::vector<cv::Mat> frames,
//    std::vector<int> keyframes)
//{
...
s_f_map
EchoQualityAssessmentA3C::predict(
    std::vector<cv::Mat> frames,  std::vector<float> radius, singleResult& results)
{
    ...
    s_f_map result_map_a3c;
    result_map_a3c["gain_score"] = gain_score_out;
    result_map_a3c["scaling_score"] = scaling_score_out;
    result_map_a3c["structure_score"] = this->structure_score;
    return result_map_a3c;
}
