...
EchoQualityAssessmentA2C::EchoQualityAssessmentA2C(EchoQualityAssessmentParams params)
{
    // -------------------------------- 先验知识参数初始化 -------------------------------- //
    this->mParams = &params;
    // 切面类型名称
    ...
    this->structure_score_structures.routine_must = { "LA","LV" };  // 常规必须项结构
    this->structure_score_structures.routine_optional = { "RV" }; // 常规可选项结构
    this->structure_score_structures.unroutine_optional = { "MV" };                  // 非常规项结构
    this->structure_score_structures.unroutine_optional_params = { 0.7f };      // 非常规项参数
    this->structure_score_weight.routine_must = 4.0f;                               // 常规必须项结构分数权重
    this->structure_score_weight.routine_optional = { -3.0f };                             // 常规可选项结构分数权重
    this->structure_score_weight.unroutine_optional = { 2.0f };               // 非常规项结构分数权重
    ...
    this->mParams->sdetection_params.score_threshold = { 0.5f, 0.5f, 0.5f, 0.5f, 0.5f };
    this->mParams->sdetection_params.frame_threshold = { 1,1,1,1,1 };
    this->mParams->sdetection_params.structures = this->structures;
    this->mParams->sdetection_params.mMean = this->mMean;

    //this->mParams->kfdetection_params.viewname = "a2c";
    //this->mParams->kfdetection_params.model_name = "keyframe_detection_a2c";
    ...
    //this->mParams->ac_params.viewname = "a2c";
    ...
    //this->mParams->ac_params.model_name = "a2c_lv_segmentation";
    ////// update 2023.12.28
    ...
    this->mParams->gain_params.viewname = "a2c";
    ...
    //this->mParams->gain_params.gain_structures = { "LV" };
    //this->mParams->gain_params.gain_threshold = { 0.5f, 0.5f, 0.5f, 0.5f };
    //this->mParams->gain_params.frame_threshold = { 0.05f, 0.05f, 0.05f, 0.05f };
...
EchoQualityAssessmentA2C::~EchoQualityAssessmentA2C()
{
...
void
EchoQualityAssessmentA2C::load_structure_model()
{
...
//void
//EchoQualityAssessmentA2C::load_keyframe_model()
//{
...
void
EchoQualityAssessmentA2C::load_gain_model()
{
...
//void
//EchoQualityAssessmentA2C::load_angle_model()
//{
...
float EchoQualityAssessmentA2C::structure_judgment(s_frames structure_frames,
    int frame_nums,
...
float
EchoQualityAssessmentA2C::scaling_judgment(s_frames structure_frames,
...
float
EchoQualityAssessmentA2C::gain_judgment(
...
//float
//EchoQualityAssessmentA2C::mandrel_judgment(
//    f_structures frame_structures,
//    std::vector<cv::Mat> frames,
...
s_f_map
EchoQualityAssessmentA2C::predict(
    std::vector<cv::Mat> frames,  std::vector<float> radius, singleResult& results)
{
  ...
  //  this->keyframes = this->keyframe_detection->predict(frames);
    ...
    s_f_map result_map_a2c;
    result_map_a2c["gain_score"] = gain_score_out;
    result_map_a2c["scaling_score"] = scaling_score_out;
    result_map_a2c["structure_score"] = this->structure_score;


    return result_map_a2c;
}
