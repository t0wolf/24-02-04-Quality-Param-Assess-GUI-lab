...
class EchoQualityAssessmentA2C
{
public:

    EchoQualityAssessmentA2C(EchoQualityAssessmentParams params);

    virtual ~EchoQualityAssessmentA2C();
...
protected:
    ...
    std::vector<float> scaling_range = { 1.0f / 3.0f, 4.0f / 5.0f };  // 相应切面缩放比例的合理范围
